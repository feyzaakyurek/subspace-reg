...
#SBATCH --job-name=mini_1projsub


DUMPED_PATH="/home/gridsan/akyurek/git/rfs-incremental/dumped"
EXP_FOLDER=$DUMPED_PATH/"1shot/converge/finetune_1shot_distance2subspace"
...
if [[ $cnt -eq $SLURM_ARRAY_TASK_ID ]]; then
    EXP_NAME=lambda_${LMBD}_trloss_${TRLOSS}_pull_${PULL}_lr_${LR}_temp_${TEMP}_maxepochs_1000_${SLURM_ARRAY_TASK_ID}
