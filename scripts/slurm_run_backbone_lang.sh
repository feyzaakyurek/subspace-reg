...
cnt=0
for MULTIPFC in 0.05 0.075 0.01; do
for DIAG_REG in 0.05 0.075; do
for QUERY_SIZE in 300 500 750 None; do
(( cnt++ ))
if [[ $cnt -eq $SLURM_ARRAY_TASK_ID ]]; then
    EXP_NAME=multipfc_${MULTIPFC}_diagreg_${DIAG_REG}_querysize_${QUERY_SIZE}
