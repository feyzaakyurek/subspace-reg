...
#SBATCH --array=1-18
#SBATCH --output=dumped/saturday_fintune/%A_%a.out
#SBATCH --error=dumped/saturday_fintune/%A_%a.err
...
DUMPED_PATH="/home/gridsan/eakyurek/gitother/rfs-incremental/dumped/saturday_fintune"
        ...
        for TRLOSS in 0.65 0.7 0.75; do
                 for LR in 0.004; do
                        ...
                        if [[ $cnt -eq $SLURM_ARRAY_TASK_ID ]]; then
                                ...
                                BACKBONE_PATH="/home/gridsan/eakyurek/gitother/rfs-incremental/dumped/resnet12_miniImageNet_lr_0.05_decay_0.0005_trans_A_trial_pretrain_classifier_lang-linear_multip_0.075_8286113/resnet12_last.pth"
