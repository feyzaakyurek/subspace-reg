...
#SBATCH --job-name=mini_1labD+


DUMPED_PATH="/home/gridsan/akyurek/git/rfs-incremental/dumped"
EXP_FOLDER=$DUMPED_PATH/"1shot/converge/finetune_label_pull_new_episodes_delta"
...
if [[ $cnt -eq $SLURM_ARRAY_TASK_ID ]]; then
    EXP_NAME=glove_lambda_${LMBD}_temp_${TEMP}_pull_${PULL}_lr_${LR}_wd_${WD}_maxepochs_1000_${SLURM_ARRAY_TASK_ID}
