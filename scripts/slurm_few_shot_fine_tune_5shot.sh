...
#SBATCH --job-name=mini_ft5D+


DUMPED_PATH="/home/gridsan/akyurek/git/rfs-incremental/dumped"
EXP_FOLDER=$DUMPED_PATH/"converge/finetune_new_episodes_delta"
...
for LR in 0.002; do
for LMBD in 0.03; do
for WD in 5e-5 5e-4 5e-3; do
(( cnt++ ))
if [[ $cnt -eq $SLURM_ARRAY_TASK_ID ]]; then
    EXP_NAME=lmbd_${LMBD}_wd_${WD}_${SLURM_ARRAY_TASK_ID}
