...
#SBATCH --job-name=pull5separate


DUMPED_PATH="/home/gridsan/akyurek/git/rfs-incremental/dumped"
EXP_FOLDER=$DUMPED_PATH/"finetune_label_pull_separate_new_episodess"
...
for TRLOSS in 0.9 1.0 1.1; do
for PULL in 0.05 0.1; do # more pull later
(( cnt++ ))
