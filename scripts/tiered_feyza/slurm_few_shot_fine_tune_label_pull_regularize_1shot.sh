...
#SBATCH --job-name=tiered_lab1D+


DUMPED_PATH="/home/gridsan/akyurek/git/rfs-incremental/dumped"
EXP_FOLDER=$DUMPED_PATH/"tiered/finetune_1shot_label_pull_converge_delta"
...
for PULL in 0.003 0.001 0.0001; do
for LR in 0.003 0.005; do
