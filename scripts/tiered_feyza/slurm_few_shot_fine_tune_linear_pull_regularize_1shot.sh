...
#SBATCH --job-name=tiered_lin1D


DUMPED_PATH="/home/gridsan/akyurek/git/rfs-incremental/dumped"
EXP_FOLDER=$DUMPED_PATH/"tiered/finetune_1shot_linear_pull_converge_delta"
DATA_PATH="/home/gridsan/akyurek/git/rfs-incremental/data"
BACKBONE_PATH="${DUMPED_PATH}/backbones/tieredImageNet/linear/resnet18/bias_false/resnet18_last_with_mapping.pth"
mkdir -p $EXP_FOLDER
#lambda_0.2_trloss_1.0_pull_0.05_lr_0.001_2
cnt=0
for LMBD in 0.3; do
for TRLOSS in 0.0; do
for PULL in 0.001; do
for LR in 0.003 0.006; do
for WD in 5e-5 5e-4; do
(( cnt++ ))
if [[ $cnt -eq $SLURM_ARRAY_TASK_ID  ]]; then
    EXP_NAME=lambda_${LMBD}_trloss_${TRLOSS}_pull_${PULL}_lr_${LR}_wd_${WD}_${SLURM_ARRAY_TASK_ID}
