...
#SBATCH --array=1-18
#SBATCH --output=dumped/concat_drop_random/%A_%a.out
#SBATCH --error=dumped/concat_drop_random/%A_%a.err
...
DUMPED_PATH="/home/gridsan/eakyurek/gitother/rfs-incremental/dumped/concat_drop_random"
        ...
        for TRLOSS in 0.65 0.7 0.75; do
                 for LR in 0.002 0.003; do
                        ...
                        if [[ $cnt -eq $SLURM_ARRAY_TASK_ID ]]; then
                                ...
                                BACKBONE_PATH="/home/gridsan/eakyurek/gitother/rfs-incremental/dumped/backbone_finetune_random/resnet12_miniImageNet_lr_0.05_decay_0.0005_trans_A_trial_pretrain_classifier_lang-linear_multip_0.075_8406958/resnet12_last.pth"
